...
import '../../views/on_boarding/signup_as_screen.dart';
...
class CreateNewPasswordController extends GetxController {
  ...
  void onCheckboxValueChange(bool isSelected, String password) {
  ...
  resetPassword({
    ...
    var response = await networkRequest.postRequest(verifyForgotPassword, data);
